...
# Random forest model
model.plot_random_forest_class_hyperparameters(X_train, X_test, y_train, y_test, \
                                            "binary buckets")

random_forest_class_results = model.get_random_forest_class_results(150, 10, 8, \
...
gradient_boost_class_results = model.get_gradient_boost_class_results(0.2, 150, 9, \
                                        X_train, X_test, y_train, y_test)
...
# Random forest model
model.plot_random_forest_class_hyperparameters(X_train, X_test, y_train, y_test, "rock")
...
# Random forest model
model.plot_random_forest_class_hyperparameters(X_train, X_test, y_train, y_test, "pop")
